...
`.trim();
	const expected =
		'<h2 id="hello%2C-world">Hello, World</h2>\n<p>lorem ipsum dolor sit amet</p>\n';
...
`.trim();
	...
	const { frontmatter, html, tocHtml, slug, title } = await render(file);
	...
	t.ok(
		html.indexOf('id="%24ubsection-2.1%3F"') >= 0,
		"Complex headings are linkified",
	);
